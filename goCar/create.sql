create table booking (id integer not null auto_increment, final_day varchar(255), inital_day varchar(255), initial_time varchar(255), id_product integer, id_user bigint, primary key (id)) engine=MyISAM;
...
create table image (id integer not null auto_increment, title varchar(255), url_image TEXT, id_product integer, primary key (id)) engine=MyISAM;
...
create table roles (id integer not null auto_increment, name varchar(20), primary key (id)) engine=MyISAM;
create table user_roles (user_id bigint not null, role_id integer not null, primary key (user_id, role_id)) engine=MyISAM;
create table user_cars (id bigint not null auto_increment, lastname varchar(255), name varchar(255), password varchar(255), username varchar(255), primary key (id)) engine=MyISAM;
alter table user_cars add constraint UKfrwwdr4x2b6psnwdrxjor3ktk unique (username);
alter table booking add constraint FKgerkr570ch4cjb15252cwx3dl foreign key (id_product) references product (id);
alter table booking add constraint FK7lty5870lhdioq6jx41cgrfhu foreign key (id_user) references user_cars (id);
alter table image add constraint FKebv5p4e8gjysj4vdgkom261ru foreign key (id_product) references product (id);
...
alter table user_roles add constraint FK578ss3t7ts2ks15yq2h01a4th foreign key (user_id) references user_cars (id);
